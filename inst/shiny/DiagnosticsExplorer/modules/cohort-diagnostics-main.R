...
createCdDatabaseDataSource <- function(
  ...
  checkmate::assertCharacter(resultDatabaseSettings$vocabularyDatabaseSchemas, null.ok = TRUE)
  ...
  if (is.null(resultDatabaseSettings$vocabularyDatabaseSchema)) {
    if (!is.null(resultDatabaseSettings$vocabularyDatabaseSchemas) && length(resultDatabaseSettings$vocabularyDatabaseSchemas) > 0) {
      resultDatabaseSettings$vocabularyDatabaseSchema <- resultDatabaseSettings$vocabularyDatabaseSchemas[1]
    } else {
