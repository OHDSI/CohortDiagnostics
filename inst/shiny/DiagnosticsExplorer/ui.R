  ...
  shinydashboard::tabItem(
    ...
    shiny::tabsetPanel(
      ...
      shiny::tabPanel(
        ...
        tags$td(
          shiny::radioButtons(
            inputId = "indexEventBreakdownPlotRadioButton",
            label = "Show",
            choiceNames = c("Concept Count", "Subject Count"),
            choiceValues = c("conceptCount", "subjectCount"),
            selected = "conceptCount",
            inline = TRUE
          )
        ),
        shinycssloaders::withSpinner(
  ...
  shinydashboard::tabItem(
    ...
    tags$table(width = '100%',
      tags$tr(
        ...
        tags$td(
          shiny::conditionalPanel(condition = "input.temporalCharacterizationType == 'Raw table' | 
                                  input.temporalCharacterizationType=='Plot'",
                                  tags$table(tags$tr(
                                    tags$td(
                                      shinyWidgets::pickerInput(
