...
characteristisc (comorbidities, drug use, etc.), and the codes found in
...
There are currently two aproaches one can take to step 1: The cohort
...
\item
  ...
  indivual zip files generated for each database, or (recommended) place
  the premerged .RDA file here.
\end{itemize}
