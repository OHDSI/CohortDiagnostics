--DDL Drop table Specification for package CohortDiagnostics package version: 2.0
 ...
 DROP TABLE IF EXISTS @resultsDatabaseSchema.cohort_inc_result;  
 DROP TABLE IF EXISTS @resultsDatabaseSchema.cohort_inc_stats;  
 ...
 DROP TABLE IF EXISTS @resultsDatabaseSchema.concept_class;  
 ...
 DROP TABLE IF EXISTS @resultsDatabaseSchema.time_ref;  
