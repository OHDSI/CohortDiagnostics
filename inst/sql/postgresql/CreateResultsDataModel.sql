...
CREATE TABLE cohort_as_features (
			...
			fs_same_day_subjects	FLOAT NOT NULL,
			fs_same_day_records	FLOAT NOT NULL,
			fs_before_days_max	FLOAT NOT NULL,
			fs_before_days_min	FLOAT NOT NULL,
			fs_before_days_avg	FLOAT NOT NULL,
			fs_before_days_sum	FLOAT NOT NULL,
			fs_before_days_count	FLOAT NOT NULL,
			fs_before_days_stdev	FLOAT NOT NULL,
			fs_after_days_max	FLOAT NOT NULL,
			fs_after_days_min	FLOAT NOT NULL,
			fs_after_days_avg	FLOAT NOT NULL,
			fs_after_days_sum	FLOAT NOT NULL,
			fs_after_days_stdev	FLOAT NOT NULL,
			fs_after_days_count	FLOAT NOT NULL,
			fs_during_days_max	FLOAT NOT NULL,
			fs_during_days_min	FLOAT NOT NULL,
			fs_during_days_avg	FLOAT NOT NULL,
			fs_during_days_sum	FLOAT NOT NULL,
			fs_during_days_stdev	FLOAT NOT NULL,
			fs_during_days_count	FLOAT NOT NULL,			
			fe_same_day_subjects	FLOAT NOT NULL,
			fe_same_day_records	FLOAT NOT NULL,
			fe_before_days_max	FLOAT NOT NULL,
			fe_before_days_min	FLOAT NOT NULL,
			fe_before_days_avg	FLOAT NOT NULL,
			fe_before_days_sum	FLOAT NOT NULL,
			fe_before_days_count	FLOAT NOT NULL,
			fe_before_days_stdev	FLOAT NOT NULL,
			fe_after_days_max	FLOAT NOT NULL,
			fe_after_days_min	FLOAT NOT NULL,
			fe_after_days_avg	FLOAT NOT NULL,
			fe_after_days_sum	FLOAT NOT NULL,
			fe_after_days_stdev	FLOAT NOT NULL,
			fe_after_days_count	FLOAT NOT NULL,
			fe_during_days_max	FLOAT NOT NULL,
			fe_during_days_min	FLOAT NOT NULL,
			fe_during_days_avg	FLOAT NOT NULL,
			fe_during_days_sum	FLOAT NOT NULL,
			fe_during_days_stdev	FLOAT NOT NULL,
			fe_during_days_count	FLOAT NOT NULL,
			fo_during_days_max	FLOAT NOT NULL,
			fo_during_days_min	FLOAT NOT NULL,
			fo_during_days_avg	FLOAT NOT NULL,
			fo_during_days_sum	FLOAT NOT NULL,
			fo_during_days_stdev	FLOAT NOT NULL,
			fo_during_days_count	FLOAT NOT NULL,
