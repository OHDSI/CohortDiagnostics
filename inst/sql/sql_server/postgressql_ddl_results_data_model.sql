--DDL Specification for package CohortDiagnostics package version: 2.0
 ...
 CREATE TABLE @resultsDatabaseSchema.analysis_ref (
			...
			missing_means_zero varchar(max) NULL );  
 ...
 CREATE TABLE @resultsDatabaseSchema.concept (
			...
			standard_concept varchar(max) NULL, 
 ...
 ----------------------------------------------------------------------- 
 --Table name concept_sets_concept_id
 --Number of fields in table 3
 --HINT DISTRIBUTE ON RANDOM
 CREATE TABLE @resultsDatabaseSchema.concept_sets_concept_id (
 ...
 ----------------------------------------------------------------------- 
 --Table name database_concept_count
 --Number of fields in table 4
 --HINT DISTRIBUTE ON RANDOM
 CREATE TABLE @resultsDatabaseSchema.database_concept_count (
 ...
 CREATE TABLE @resultsDatabaseSchema.phenotype_description (
			...
			parent_synonyms varchar(max) NULL, 
			child_names varchar(max) NULL );  
 ...
 CREATE TABLE @resultsDatabaseSchema.vocabulary (
			...
			vocabulary_version varchar(max) NULL, 
