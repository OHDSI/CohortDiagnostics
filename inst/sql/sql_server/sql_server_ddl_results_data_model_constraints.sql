--DDL Primary Key Constraints Specification for package CohortDiagnostics package version: 2.0
 ...
 ALTER TABLE @resultsDatabaseSchema.cohort_inclusion_result ADD CONSTRAINT xpk_cohort_inclusion_result PRIMARY KEY NONCLUSTERED (cohort_definition_id,mode_id);  
 ALTER TABLE @resultsDatabaseSchema.cohort_inclusion_stats ADD CONSTRAINT xpk_cohort_inclusion_stats PRIMARY KEY NONCLUSTERED (cohort_definition_id,rule_sequence,mode_id);  
 ...
 ALTER TABLE @resultsDatabaseSchema.concept_synonym ADD CONSTRAINT xpk_concept_synonym PRIMARY KEY NONCLUSTERED (concept_id,language_concept_id);  
 ALTER TABLE @resultsDatabaseSchema.covariate_ref ADD CONSTRAINT xpk_covariate_ref PRIMARY KEY NONCLUSTERED (covariate_id,covariate_analysis_id,concept_id);  
 ...
 ALTER TABLE @resultsDatabaseSchema.time_distribution ADD CONSTRAINT xpk_time_distribution PRIMARY KEY NONCLUSTERED (cohort_definition_id,database_id);  
