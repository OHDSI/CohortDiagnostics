--DDL Primary Key Constraints Specification for package CohortDiagnostics package version: 2.0
 ...
 ALTER TABLE @resultsDatabaseSchema.concept_sets_concept_id ADD CONSTRAINT xpk_concept_sets_concept_id PRIMARY KEY NONCLUSTERED (cohort_id,concept_set_id,concept_id);  
 ...
 ALTER TABLE @resultsDatabaseSchema.database_concept_count ADD CONSTRAINT xpk_database_concept_count PRIMARY KEY NONCLUSTERED (database_id,concept_id);  
