...
#' Batch Inclusion Rules
#' 
#' @description Batch generation of inclusion rule for multiple cohorts in Cohort Diagnostics
#' 
#' @template Connection
#'
...
#'                                   'scratch.dbo'.
#'                                   
#' @param cohortTableNames           The names of the cohort tables. See \code{\link{CohortGenerator::getCohortTableNames}}
#'                                   for more details.
#' 
...
#' 
#' @export
batchInclusionStats <- function(connection,
