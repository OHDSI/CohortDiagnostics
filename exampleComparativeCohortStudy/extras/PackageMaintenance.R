...
OhdsiRTools::checkUsagePackage("exampleStudy")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/exampleStudy.pdf")
shell("R CMD Rd2pdf ./ --output=extras/exampleStudy.pdf")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("exampleStudy")
